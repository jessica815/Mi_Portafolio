...
// Notificacion push with firebase
// self.addEventListener('push', function(event) {
//   console.log('Push recieved', event);
//   var title = 'Ya casi estamos listos';
//   var body = 'Para poder usar nuestra aplicación, debes registrarte';
//   var icon = './images/icon-512x512.png';
//   event.waitUntil(
